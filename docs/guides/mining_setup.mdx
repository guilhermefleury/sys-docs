...
- **[Mining-Dutch](https://www.mining-dutch.nl/index.php?page=gettingstarted)**
...
You can also take a look at [src/test/auxpow_tests.cpp](https://github.com/syscoin/syscoin/blob/master/src/test/auxpow_tests.cpp). Take a look at [test/functional/auxpow_mining.py](https://github.com/syscoin/syscoin/blob/master/test/functional/auxpow_mining.py) for example code that constructs and mines (with regtest difficulty) an AuxPoW block.

...
sidebar_label: fundrawtransaction
description: "Syscoin Core CLI reference: fundrawtransaction"
---
...
*Source: [src/wallet/rpc/spend.cpp](https://github.com/syscoin/syscoin/blob/master/src/wallet/rpc/spend.cpp). Auto-generated from Syscoin Core 5.0.5 on 2026-05-20.*

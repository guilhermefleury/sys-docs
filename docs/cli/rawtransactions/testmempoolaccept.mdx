...
sidebar_label: testmempoolaccept
description: "Syscoin Core CLI reference: testmempoolaccept"
---
...
[                                 (json array) The result of the mempool acceptance test for each raw transaction in the input array.
  ...
  {                               (json object)
    ...
    "fees" : {                    (json object, optional) Transaction fees (only present if 'allowed' is true)
      ...
      "effective-feerate" : n,    (numeric) the effective feerate in SYS per KvB. May differ from the base feerate if, for example, there are modified fees from prioritisetransaction or a package feerate was used.

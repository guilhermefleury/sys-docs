...
sidebar_label: signrawtransactionwithkey
description: "Syscoin Core CLI reference: signrawtransactionwithkey"
---
...
```
> syscoin-cli signrawtransactionwithkey "myhex" "[\"key1\",\"key2\"]"

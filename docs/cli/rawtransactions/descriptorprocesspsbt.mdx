---
title: descriptorprocesspsbt
sidebar_label: descriptorprocesspsbt
...
```
> syscoin-cli descriptorprocesspsbt "psbt" "[\"descriptor1\", \"descriptor2\"]"
> syscoin-cli descriptorprocesspsbt "psbt" "[{\"desc\":\"mydescriptor\", \"range\":21}]"
```

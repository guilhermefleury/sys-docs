...
sidebar_label: getchainstates
description: "Syscoin Core CLI reference: getchainstates"
---
...
```
> syscoin-cli getchainstates 
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "getchainstates", "params": []}' -H 'content-type: text/plain;' http://127.0.0.1:8370/
```

...
sidebar_label: getdeploymentinfo
description: "Syscoin Core CLI reference: getdeploymentinfo"
---
...
```
> syscoin-cli getdeploymentinfo 
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "getdeploymentinfo", "params": []}' -H 'content-type: text/plain;' http://127.0.0.1:8370/
```

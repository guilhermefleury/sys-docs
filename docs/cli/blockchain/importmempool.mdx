---
title: importmempool
sidebar_label: importmempool
description: "Syscoin Core CLI reference: importmempool"
---
...
```
> syscoin-cli importmempool /path/to/mempool.dat
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "importmempool", "params": [/path/to/mempool.dat]}' -H 'content-type: text/plain;' http://127.0.0.1:8370/
```

---
title: walletcreatefundedpsbt
sidebar_label: walletcreatefundedpsbt
description: "Syscoin Core CLI reference: walletcreatefundedpsbt"
---
...
changeAddress              (string, optional, default=automatic) The syscoin address to receive the change
...
feeRate                    (numeric or string, optional, default=not set, fall back to wallet fee estimation) Specify a fee rate in SYS/kvB.

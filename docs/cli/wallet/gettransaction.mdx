...
description: "Syscoin Core CLI reference: gettransaction"
---
...
```
{                                          (json object)
  "amount" : n,                            (numeric) The amount in SYS
  ...
  "details" : [                            (json array)
    {                                      (json object)
      ...
      "address" : "str",                   (string, optional) The syscoin address involved in the transaction.

---
title: listunspent
sidebar_label: listunspent
description: "Syscoin Core CLI reference: listunspent"
---
...
Named Arguments:
minimumAmount                (numeric or string, optional, default="0.00") Minimum value of each UTXO in SYS
maximumAmount                (numeric or string, optional, default=unlimited) Maximum value of each UTXO in SYS
maximumCount                 (numeric, optional, default=unlimited) Maximum number of UTXOs
minimumSumAmount             (numeric or string, optional, default=unlimited) Minimum sum value of all UTXOs in SYS
...
[                                (json array)
  {                              (json object)
    ...
    "asset_guid" : n,            (numeric, optional) Asset GUID if exists
    "asset_amount" : n           (numeric, optional) Asset amount if exists
  },
  ...
]
```

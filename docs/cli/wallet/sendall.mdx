---
title: sendall
sidebar_label: sendall
description: "Syscoin Core CLI reference: sendall"
---
...
1. recipients                  (json array, required) The sendall destinations. Each address may only appear once.
     ...
     [
       "address",              (string, required) A syscoin address which receives an equal share of the unspecified amount.
       {                       (json object)
...
> syscoin-cli -named sendall recipients='["sys1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"]' fee_rate=1

Spend all UTXOs with a fee rate of 1.1 sat/vB using positional arguments
> syscoin-cli sendall '["sys1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"]' null "unset" 1.1

Spend all UTXOs split into equal amounts to two addresses with a fee rate of 1.5 sat/vB using the options argument
> syscoin-cli sendall '["sys1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "sys1qtyf33aa2tl62xhrzhralpytka0krxvt0a4e8ee"]' null "unset" null '{"fee_rate": 1.5}'
...
> syscoin-cli sendall '["sys1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"]' null "unset" null '{"fee_rate": 10, "send_max": true}'

Spend all UTXOs with a fee rate of 1.3 sat/vB using named arguments and sending a 0.25 SYS to another recipient
> syscoin-cli -named sendall recipients='[{"sys1qtyf33aa2tl62xhrzhralpytka0krxvt0a4e8ee": 0.25}, "sys1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"]' fee_rate=1.3
```

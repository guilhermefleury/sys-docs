...
sidebar_label: listtransactions
description: "Syscoin Core CLI reference: listtransactions"
---
...
[                                        (json array)
  {                                      (json object)
    ...
    "address" : "str",                   (string, optional) The syscoin address of the transaction (not returned if the output does not have an address, e.g. OP_RETURN null data).
    ...
    "amount" : n,                        (numeric) The amount in SYS. This is negative for the 'send' category, and is positive
                                         for all other categories
    "label" : "str",                     (string, optional) A comment for the address/transaction, if any
    "vout" : n,                          (numeric) the vout value
    "fee" : n,                           (numeric, optional) The amount of the fee in SYS. This is negative and only available for the

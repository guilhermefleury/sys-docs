...
sidebar_label: listreceivedbyaddress
description: "Syscoin Core CLI reference: listreceivedbyaddress"
---
...
[                                        (json array)
  {                                      (json object)
    ...
    "amount" : n,                        (numeric) The total amount in SYS received by the address
...
> syscoin-cli listreceivedbyaddress 6 true true "" true
...
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "listreceivedbyaddress", "params": [6, true, true, "sys1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", true]}' -H 'content-type: text/plain;' http://127.0.0.1:8370/
```

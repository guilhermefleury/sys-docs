...
description: "Syscoin Core CLI reference: signmessage"
---
...
*Source: [src/wallet/rpc/signmessage.cpp](https://github.com/syscoin/syscoin/blob/master/src/wallet/rpc/signmessage.cpp). Auto-generated from Syscoin Core 5.0.5 on 2026-05-15.*

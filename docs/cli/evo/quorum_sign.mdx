---
title: quorum_sign
sidebar_label: quorum_sign
description: "Syscoin Core CLI reference: quorum_sign"
---
...
```
quorum_sign "id" "msgHash" ( "quorumHash" submit )
```
...
4. submit        (boolean, optional) Submits the signature share to the network if this is true.
```

## Examples

```
> syscoin-cli quorum_sign 1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d 1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d 1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d

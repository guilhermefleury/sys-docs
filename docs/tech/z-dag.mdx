...
Whiteblock's 2019 report on Z-DAG is no longer hosted at its original URL; a summary of the audit results is preserved in the [Syscoin whitepaper](https://syscoin.org/whitepaper#tps).
